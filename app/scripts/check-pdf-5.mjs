#!/usr/bin/env node
/* scripts/check-pdf-5.mjs — проверка сборника «Задание 5».
   Запуск: pnpm test:pdf-5
   ...
   Проверки идут по готовым файлам в app/public/materials/zadanie-5
...
import { collectSections, content, naming } from './lib/sheet5-tasks.mjs';
