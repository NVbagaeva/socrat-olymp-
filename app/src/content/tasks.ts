...
export interface ExamTask {
  ...
  no: string;
  /**
   * Полное название — единственное. Сокращений нет нигде: в сайдбаре
   * длинное название переносится на вторую строку, а не режется.
   */
  name: string;
...
export const tasks = [
  ...
  {
    no: '13',
    name: 'Финансовая грамотность: экономические задачи',
    slug: '13',
    status: 'soon',
    badge: 'структура 2027',
  },
