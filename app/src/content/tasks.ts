...
export const tasks = [
  ...
  /* Названия обоих разделов — из кодификатора ФИПИ: те же слова
     стоят в заголовке страницы задания, и двух имён у одной темы
     быть не должно. Для сайдбара у №4 задана короткая форма. */
  {
    no: '04',
