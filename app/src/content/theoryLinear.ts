...
export const whatIsFunction: WhatIsFunctionContent = {
  ...
  rule: {
    ...
    text: [
      { text: 'Функция', strong: true },
      { text: ' — это зависимость, при которой каждому значению независимой переменной ' },
      { text: 'x', math: true },
      { text: ' по некоторому правилу ставится в соответствие ' },
      { text: 'единственное значение зависимой переменной ', strong: true },
