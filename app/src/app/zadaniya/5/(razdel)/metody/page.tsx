...
/**
 * Вкладка «Ключевые методы решения» задания №5: двенадцать методов
 * автора карточками, каждая открывает модалку метода. Тот же
 * компонент, что у задания №4, — с составом методов задания №5.
 */
