...
var RULES = {
  ...
  /* Второй вариант скрытой точки — нецелая внутри окна: не у самой
     рамки и не сливается с видимой. */
  crossInsideMargin: 1,  /* нецелая точка не ближе клетки к рамке           */
  crossSeparation:   1.5 /* расстояние между точками пересечения, клеток    */
};
