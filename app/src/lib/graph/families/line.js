...
export default api;
export { RULES, frac, toFrac, add, sub, mul, div, num, isInt, isZero, create, yAt, xForValue, axisIntersections, contains, intersect, integerPoints, referencePoints, visiblePart, crossesWindow, slopeReadable, distinguishable, windowFor };
