...
export const P03_45: Prototype = {
  ...
  shagi: (p) => {
    ...
    return [
      {
        text: 'Сечение — квадрат, подобный основанию с коэффициентом одна вторая (вершины — середины рёбер).',
      },
      {
...
export const P03_50: Prototype = {
  ...
  shagi: (p) => {
    ...
    return [
      {
        text: 'Средняя линия отсекает от основания треугольник площадью в четверть исходного (подобие с коэффициентом одна вторая); высота у отсечённой пирамиды та же.',
      },
      {
