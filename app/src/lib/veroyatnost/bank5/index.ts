/**
 * Банк задания №5: тринадцать прототипов по двенадцати методам,
 * утверждённым автором (metody5.ts), — задачи 1–58 задачника
 * Е. А. Ширяевой «ЕГЭпроф 2025». У метода «Умножение независимых
 * событий» два прототипа: две партии и четыре выстрела.
 *
