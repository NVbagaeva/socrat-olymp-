 ...
 * 5.2 противоположное событие, 5.5 кофейные автоматы, 5.12 подбор
 * наименьшего n. Рисунка у них нет — только шаги с формулами.
 *
...
/* ── 5.5. Кофейные автоматы: два автомата ────────────────────────── */

const P04: Prototype = prototip({
  id: 'p5-04',
  blok: 'kofeynye-avtomaty',
  nazvanie: 'Два автомата: кофе останется в обоих',
  tip: 'Кофейные автоматы',
  zadachnik: [21, 24],
  format: 'десятичная',
  okruglenie: tochno,
  uslovie: (p) =>
...
/* ── 5.12. Подбор наименьшего n: патроны ─────────────────────────── */
