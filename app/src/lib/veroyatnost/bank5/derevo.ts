/**
 * Задание №5, прототипы на дереве вероятностей: 5.6 произведение
 * (шахматы), 5.7 серия испытаний (стрелок и четыре мишени),
 * 5.8 «хотя бы один» (лампы), 5.9 два выбора без возвращения
 * (фломастеры), 5.10 сумма очков в двух играх (футбол).
 *
...
const P06: Prototype = prototip({
  ...
  tip: 'Произведение независимых событий',
  zadachnik: [29, 32],
  format: 'десятичная',
  okruglenie: tochno,
  uslovie: (p) =>
...
const P07: Prototype = prototip({
  ...
  tip: 'Серия независимых испытаний',
  zadachnik: [33, 36],
  format: 'десятичная',
  okruglenie: tochno,
  uslovie: (p) =>
...
/* ── 5.9. Фломастеры: один синий и один красный ──────────────────── */
...
const P09: Prototype = prototip({
  id: 'p5-09',
  blok: 'dva-bez-vozvrata',
  nazvanie: 'Фломастеры: один синий и один красный',
  tip: 'Два выбора без возвращения',
  zadachnik: [41, 44],
  format: 'десятичная',
  okruglenie: tochno,
  uslovie: (p) =>
