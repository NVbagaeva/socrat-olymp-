/**
 * Задание №5, прототипы на дереве вероятностей: 5.6 умножение
 * независимых событий — три прототипа (шахматы; стрелок и четыре
 * мишени; футбол с несколькими сценариями), 5.7 задачи со словами
 * «хотя бы» (лампы), 5.8 два предмета из коробки (фломастеры).
 *
...
/* ── 5.6а. Умножение независимых: шахматы, обе партии ────────────── */
...
/* ── 5.6б. Умножение независимых: стрелок и четыре мишени ────────── */
...
/* ── 5.7. «Хотя бы»: лампы, хотя бы одна не перегорит ────────────── */
...
/* ── 5.8. Два предмета из коробки: фломастеры ────────────────────── */
...
/* ── 5.6в. Умножение независимых: футбол, несколько сценариев ────── */
