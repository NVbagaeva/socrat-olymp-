 ...
 * (разность вложенных событий, 100 объектов), 5.4а совместные события
 * (масса хлеба, 100 буханок) и 5.9 формула полной вероятности
 * (10 000 объектов). Рисунок — сетка 10×10, искомая группа подсвечена.
 *
 ...
 * типологии автора другой, и в банке он стоит в блоке совместных
 * событий рядом с кофейными автоматами.
 */
...
/* ── 5.4а. Совместные события: масса хлеба ───────────────────────── */
...
/* ── 5.9. Формула полной вероятности: батарейки ──────────────────── */
...
const P11: Prototype = prototip({
  ...
  tip: 'Формула полной вероятности: решаем через дерево',
  zadachnik: [49, 54],
  format: 'десятичная',
  okruglenie: tochno,
  uslovie: (p) =>
